...
class DocumentResourceIT {
    ...
    public static Document createEntity(EntityManager em) {
        Document document = new Document().file(DEFAULT_FILE).fileContentType(DEFAULT_FILE_CONTENT_TYPE).comments(DEFAULT_COMMENTS);
        return document;
    }
    ...
    public static Document createUpdatedEntity(EntityManager em) {
        Document document = new Document().file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).comments(UPDATED_COMMENTS);
        return document;
    }
    ...
    void createDocument() throws Exception {
        ...
        assertThat(testDocument.getComments()).isEqualTo(DEFAULT_COMMENTS);
    }
    ...
    void getAllDocumentsByTypeIsEqualToSomething() throws Exception {
        // Initialize the database
        documentRepository.saveAndFlush(document);
        DocumentType type = DocumentTypeResourceIT.createEntity(em);
        em.persist(type);
        em.flush();
        ...
        // Get all the documentList where type equals to typeId
        defaultDocumentShouldBeFound("typeId.equals=" + typeId);

        // Get all the documentList where type equals to (typeId + 1)
        defaultDocumentShouldNotBeFound("typeId.equals=" + (typeId + 1));
    }
    ...
    void putNewDocument() throws Exception {
        ...
        updatedDocument.file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).comments(UPDATED_COMMENTS);
        ...
        assertThat(testDocument.getComments()).isEqualTo(UPDATED_COMMENTS);
    }
    ...
    void partialUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.comments(UPDATED_COMMENTS);
    ...
    void fullUpdateDocumentWithPatch() throws Exception {
        ...
        partialUpdatedDocument.file(UPDATED_FILE).fileContentType(UPDATED_FILE_CONTENT_TYPE).comments(UPDATED_COMMENTS);
