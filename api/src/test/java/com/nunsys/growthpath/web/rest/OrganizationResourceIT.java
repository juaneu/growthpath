...
class OrganizationResourceIT {
    ...
    public static Organization createEntity(EntityManager em) {
        Organization organization = new Organization().name(DEFAULT_NAME).logo(DEFAULT_LOGO).logoContentType(DEFAULT_LOGO_CONTENT_TYPE);
        return organization;
    }
    ...
    public static Organization createUpdatedEntity(EntityManager em) {
        Organization organization = new Organization().name(UPDATED_NAME).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
        return organization;
    }
    ...
    @Test
    @Transactional
    void getAllOrganizationsByResponsableIsEqualToSomething() throws Exception {
        // Initialize the database
        organizationRepository.saveAndFlush(organization);
        User responsable = UserResourceIT.createEntity(em);
        em.persist(responsable);
        em.flush();
        organization.setResponsable(responsable);
        organizationRepository.saveAndFlush(organization);
        Long responsableId = responsable.getId();

        // Get all the organizationList where responsable equals to responsableId
        defaultOrganizationShouldBeFound("responsableId.equals=" + responsableId);

        // Get all the organizationList where responsable equals to (responsableId + 1)
        defaultOrganizationShouldNotBeFound("responsableId.equals=" + (responsableId + 1));
    }
    ...
    void putNewOrganization() throws Exception {
        ...
        updatedOrganization.name(UPDATED_NAME).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
    ...
    void fullUpdateOrganizationWithPatch() throws Exception {
        ...
        partialUpdatedOrganization.name(UPDATED_NAME).logo(UPDATED_LOGO).logoContentType(UPDATED_LOGO_CONTENT_TYPE);
